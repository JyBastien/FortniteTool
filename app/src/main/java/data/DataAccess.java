...
public class DataAccess extends SQLiteOpenHelper {
    ...
    public final static String TABLE_COULEUR = "Couleur";
    public final static String COL_NUMERO = "Numero";
    ...
    public final static String COULEUR_DDL = "create table " + TABLE_COULEUR + "(" +
            COL_NUMERO + " INTEGER primary key)";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        sqLiteDatabase.execSQL(COULEUR_DDL);
        sqLiteDatabase.execSQL("insert into couleur values(" + Color.CYAN + ")");
    }
}
